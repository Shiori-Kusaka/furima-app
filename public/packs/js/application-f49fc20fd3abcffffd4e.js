...
var card = function card() {
  Payjp.setPublicKey("pk_test_b87fe81b9242d337180e0598");
  ...
  form.addEventListener("submit", function (e) {
    ...
    Payjp.createToken(card, function (status, response) {
      if (status == 200) {
        ...
        var tokenObj = "<input value=".concat(token, " name='token'>");
...
function math() {
  ...
  Price.addEventListener("keyup", function () {
    ...
    var beforeTax = ItemPrice * Tax;
    var afterTaxFee = Math.floor(beforeTax);
    var ProfitPrice = ItemPrice - afterTaxFee;
...
__webpack_require__(/*! ../math */ "./app/javascript/math.js");
...
/******/ });
//# sourceMappingURL=application-f49fc20fd3abcffffd4e.js.map